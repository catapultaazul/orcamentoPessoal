...
function cadastrarDespesa() {
    ...
    if (despesa.validarDados()) {
        ...
        document.getElementById('modalTitle').innerHTML = 'Registro realizado com sucesso'
        ...
        document.getElementById('modalBody').innerHTML = 'Erro na gravação, verifique os campos digitados'
